<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AtendimentoMensal.aspx.cs" Inherits="PortalAtividade.Pages.Kpi.AtendimentoMensal" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <h2 class="pt-4">Atendimento Mensal</h2>
    <h3 class="pb-2">Atividades atendidas por analista e o tempo que ficaram abertas</h3>
    ...
    <h5 class="pt-4"><asp:Literal ID="ltlNome" runat="server" /></h5>
    ...
    <script>
        $("[id$=txtAnalise1],[id$=txtAnalise2],[id$=txtAnalise3],[id$=txtAnalise4]").on('keypress', function (event) {
