<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EmFilaMensal.aspx.cs" Inherits="PortalAtividade.Pages.Kpi.EmFilaMensal" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <h2 class="pt-4">Chamados em Fila Mensal</h2>
    <h3 class="pb-2">Plano (Meta) e Prazo para redução dos Chamados em Fila</h3>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group">
                <label><asp:Literal ID="ltlPergunta5" runat="server" /></label>
                <asp:TextBox ID="txtAnalise5" TextMode="MultiLine" Height="250px" CssClass="form-control" runat="server" />
            </div>
        </div>
    </div>
    ...
    <script>
        $("[id$=txtAnalise1],[id$=txtAnalise2],[id$=txtAnalise3],[id$=txtAnalise4],[id$=txtAnalise5]").on('keypress', function (event) {
